...
class AdminProductionJpaQueryRepositoryTest {
    ...
    void 프로덕션리스트조회테스트() {
        ...
        // then
        assertThat(adminProductionJpaQueryRepository.findProductionList(productionMap)).isNotEmpty();
    }
    ...
    void 프로덕션Mockito조회테스트() {
        ...
        // when
        when(mockAdminProductionJpaQueryRepository.findProductionList(productionMap)).thenReturn(productionList);
        List<AdminProductionDTO> newProductionList = mockAdminProductionJpaQueryRepository.findProductionList(productionMap);
        ...
        // verify
        verify(mockAdminProductionJpaQueryRepository, times(1)).findProductionList(productionMap);
        verify(mockAdminProductionJpaQueryRepository, atLeastOnce()).findProductionList(productionMap);
        ...
        inOrder.verify(mockAdminProductionJpaQueryRepository).findProductionList(productionMap);
    }
    ...
    void 프로덕션BDD조회테스트() {
        ...
        // when
        given(mockAdminProductionJpaQueryRepository.findProductionList(productionMap)).willReturn(productionList);
        List<AdminProductionDTO> newProductionList = mockAdminProductionJpaQueryRepository.findProductionList(productionMap);
        ...
        // verify
        then(mockAdminProductionJpaQueryRepository).should(times(1)).findProductionList(productionMap);
        then(mockAdminProductionJpaQueryRepository).should(atLeastOnce()).findProductionList(productionMap);
    ...
    void 프로덕션어드민코멘트조회Mockito테스트() {
        ...
        Long productionIdx = adminProductionJpaRepository.save(adminProductionEntity).getIdx();
        ...
        when(mockAdminProductionJpaQueryRepository.findProductionAdminComment(adminProductionEntity.getIdx())).thenReturn(adminCommentList);
        List<AdminCommentDTO> newAdminCommentList = mockAdminProductionJpaQueryRepository.findProductionAdminComment(adminProductionEntity.getIdx());
        ...
        // verify
        verify(mockAdminProductionJpaQueryRepository, times(1)).findProductionAdminComment(adminProductionEntity.getIdx());
        verify(mockAdminProductionJpaQueryRepository, atLeastOnce()).findProductionAdminComment(adminProductionEntity.getIdx());
        verifyNoMoreInteractions(mockAdminProductionJpaQueryRepository);

        InOrder inOrder = inOrder(mockAdminProductionJpaQueryRepository);
        inOrder.verify(mockAdminProductionJpaQueryRepository).findProductionAdminComment(adminProductionEntity.getIdx());
    }
    ...
    void 프로덕션어드민코멘트조회BDD테스트() {
        ...
        given(mockAdminProductionJpaQueryRepository.findProductionAdminComment(adminProductionEntity.getIdx())).willReturn(adminCommentList);
        List<AdminCommentDTO> newAdminCommentList = mockAdminProductionJpaQueryRepository.findProductionAdminComment(adminProductionEntity.getIdx());
        ...
        // verify
        then(mockAdminProductionJpaQueryRepository).should(times(1)).findProductionAdminComment(adminProductionEntity.getIdx());
        then(mockAdminProductionJpaQueryRepository).should(atLeastOnce()).findProductionAdminComment(adminProductionEntity.getIdx());
        then(mockAdminProductionJpaQueryRepository).shouldHaveNoMoreInteractions();
    }
}