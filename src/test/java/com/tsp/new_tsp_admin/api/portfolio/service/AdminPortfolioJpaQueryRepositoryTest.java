...
class AdminPortfolioJpaQueryRepositoryTest {
    ...
    void 포트폴리오어드민코멘트조회Mockito테스트() {
        ...
        AdminPortFolioEntity saveEntity = adminPortfolioJpaRepository.save(adminPortFolioEntity);
        ...
        adminCommentList.add(AdminCommentDTO.builder()
                .comment("코멘트 테스트")
                .commentType("portfolio")
                .commentTypeIdx(saveEntity.getIdx())
                .visible("Y")
                .build());

        when(mockAdminPortfolioJpaQueryRepository.findPortfolioAdminComment(adminPortFolioEntity.getIdx())).thenReturn(adminCommentList);
        List<AdminCommentDTO> newAdminCommentList = mockAdminPortfolioJpaQueryRepository.findPortfolioAdminComment(adminPortFolioEntity.getIdx());
        ...
        // verify
        verify(mockAdminPortfolioJpaQueryRepository, times(1)).findPortfolioAdminComment(adminPortFolioEntity.getIdx());
        verify(mockAdminPortfolioJpaQueryRepository, atLeastOnce()).findPortfolioAdminComment(adminPortFolioEntity.getIdx());
        verifyNoMoreInteractions(mockAdminPortfolioJpaQueryRepository);

        InOrder inOrder = inOrder(mockAdminPortfolioJpaQueryRepository);
        inOrder.verify(mockAdminPortfolioJpaQueryRepository).findPortfolioAdminComment(adminPortFolioEntity.getIdx());
    }
    ...
    void 포트폴리오어드민코멘트조회BDD테스트() {
        ...
        given(mockAdminPortfolioJpaQueryRepository.findPortfolioAdminComment(adminPortFolioEntity.getIdx())).willReturn(adminCommentList);
        List<AdminCommentDTO> newAdminCommentList = mockAdminPortfolioJpaQueryRepository.findPortfolioAdminComment(adminPortFolioEntity.getIdx());
        ...
        // verify
        then(mockAdminPortfolioJpaQueryRepository).should(times(1)).findPortfolioAdminComment(adminPortFolioEntity.getIdx());
        then(mockAdminPortfolioJpaQueryRepository).should(atLeastOnce()).findPortfolioAdminComment(adminPortFolioEntity.getIdx());
        then(mockAdminPortfolioJpaQueryRepository).shouldHaveNoMoreInteractions();
    }
}