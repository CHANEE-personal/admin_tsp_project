...
public enum ApiExceptionType implements BaseExceptionType {
    ...
    // 이미지 관련 TYPE
    NOT_FOUND_IMAGE("NOT_FOUND_IMAGE", 200, "이미지 없음"),
    ...
    // 모델 섭외 관련 TYPE
    NOT_FOUND_MODEL_NEGOTIATION_LIST("NOT_FOUND_MODEL_NEGOTIATION_LIST", 200, "모델 섭외 리스트 없음"),
    NOT_FOUND_MODEL_NEGOTIATION("NOT_FOUND_MODEL_NEGOTIATION", 200, "모델 섭외 없음"),
